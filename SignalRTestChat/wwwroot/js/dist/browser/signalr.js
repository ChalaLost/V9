...
t = self, e = function () {
    return (() => {
        ...
        function y(t, e) {
            let s = "";
            return m(t) ? (s = `Binary data of length ${t.byteLength}`, e && (s += `. Content: '${function (t) { const e = new Uint8Array(t); let s = ""; return e.forEach((t => { s += `0x${t < 16 ? "0" : ""}${t.toString(16)} ` })), s.substr(0, s.length - 1) }(t)}'`)) : "string" == typeof t && (s = `String data of length ${t.length}`, e && (s += `. Content: '${t}'`)), s
        }
        ...
        async function b(t, s, n, i, r, o, h) {
            ...
            const [a, l] = $();
            c[a] = l, t.log(e.Trace, `(${s} transport) sending data. ${y(o, h.logMessageContent)}.`);
            const u = m(o) ? "arraybuffer" : "text",
                d = await n.post(i, {
                    content: o,
                    headers: {
                        ...c,
        ...
        class H extends d {
            constructor(t) {
                if (super(), "undefined" != typeof fetch || g.isNode) this.$ = new T(t);
                else {
        ...
        class N {
            constructor(t, s, n, i) {
                ...
                }, w.isRequired(t, "connection"), w.isRequired(s, "logger"), w.isRequired(n, "protocol"), this.serverTimeoutInMilliseconds = 3e4, this.keepAliveIntervalInMilliseconds = 15e3, this.u = s, this.k = n, this.connection = t, this.P = i, this.T = new x, this.connection.onreceive = t => this.I(t), this.connection.onclose = t => this._(t), this.H = {}, this.D = {}, this.A = [], this.R = [], this.U = [], this.N = 0, this.L = !1, this.q = R.Disconnected, this.j = !1, this.M = this.k.writeMessage({
                    type: A.Ping
                })
            }
            ...
            async O() {
                ...
                try {
                    await this.F(), g.isBrowser && window.document.addEventListener("freeze", this.S), this.q = R.Connected, this.j = !0, this.u.log(e.Debug, "HubConnection connected successfully.")
                } catch (t) {
            ...
            stream(t, ...e) {
                const [s, n] = this.it(e), i = this.rt(t, e, n);
                let r;
                const o = new U;
            ...
            send(t, ...e) {
                const [s, n] = this.it(e), i = this.ht(this.at(t, e, !0, n));
                return this.ct(s, i), i
            }
            invoke(t, ...e) {
                const [s, n] = this.it(e), i = this.at(t, e, !1, n);
            ...
            off(t, e) {
                ...
                if (s)
                    if (e) {
                        const n = s.indexOf(e); - 1 !== n && (s.splice(n, 1), 0 === s.length && delete this.D[t])
            ...
            it(t) {
                ...
                for (let n = 0; n < t.length; n++) {
                    ...
                    if (this.Et(i)) {
                        const r = this.N;
                        this.N++, e[r] = i, s.push(r.toString()), t.splice(n, 1)
                    }
                }
                return [e, s]
            }
        ...
        class F {
            ...
            async connect(t, s) {
                if (w.isRequired(t, "url"), w.isRequired(s, "transferFormat"), w.isIn(s, W, "transferFormat"), this.It = t, this.u.log(e.Trace, "(LongPolling transport) Connecting."), s === W.Binary && "undefined" != typeof XMLHttpRequest && "string" != typeof (new XMLHttpRequest).responseType) throw new Error("Binary protocols over XmlHttpRequest not implementing advanced features are not supported.");
                const [i, r] = $(), o = {
                    [i]: r,
                    ...this.Pt.headers
                }, h = {
            ...
            Ht(t, e) {
                t.headers || (t.headers = {}), e ? t.headers[j.Authorization] = `Bearer ${e}` : t.headers[j.Authorization] && delete t.headers[j.Authorization]
            }
            async At(t, s) {
                try {
                    for (; this.Tt;) {
        ...
        class B {
                        ...
                        try {
                            r.onmessage = t => {
                                if (this.onreceive) try {
                                    this.u.log(e.Trace, `(SSE transport) data received. ${y(t.data, this.Pt.logMessageContent)}.`), this.onreceive(t.data)
                                } catch (t) {
                                ...
                                this.u.log(e.Information, `SSE connected to ${this.It}`), this.Nt = r, o = !0, n()
                            }
                        } catch (t) {
                            return void i(t)
                        }
            ...
            async send(t) {
                return this.Nt ? b(this.u, "SSE", this.$, this.It, this.St, t, this.Pt) : Promise.reject(new Error("Cannot send until the transport is connected"))
            }
            stop() {
        ...
        class X {
            ...
            async connect(t, s) {
                ...
                return new Promise(((n, i) => {
                    ...
                    if (g.isNode) {
                        const e = {},
                            [s, n] = $();
                        e[s] = n, o && (e[j.Cookie] = `${o}`), r = new this.qt(t, void 0, {
                            headers: {
                                ...e,
                                ...this.jt
                            }
                    ...
                    r || (r = new this.qt(t)), s === W.Binary && (r.binaryType = "arraybuffer"), r.onopen = s => {
                        this.u.log(e.Information, `WebSocket connected to ${t}.`), this.Mt = r, h = !0, n()
                    }, r.onerror = t => {
                        let s = null;
                        ...
                        if (this.u.log(e.Trace, `(WebSockets transport) data received. ${y(t.data, this.Lt)}.`), this.onreceive) try {
            ...
            send(t) {
                return this.Mt && this.Mt.readyState === this.qt.OPEN ? (this.u.log(e.Trace, `(WebSockets transport) sending data. ${y(t, this.Lt)}.`), this.Mt.send(t), Promise.resolve()) : Promise.reject("WebSocket is not in the OPEN state")
            }
            stop() {
                return this.Mt && this.Ut(void 0), Promise.resolve()
            }
            Ut(t) {
                this.Mt && (this.Mt.onclose = () => { }, this.Mt.onmessage = () => { }, this.Mt.onerror = () => { }, this.Mt.close(), this.Mt = void 0), this.u.log(e.Trace, "(WebSockets transport) socket closed."), this.onclose && (!this.Wt(t) || !1 !== t.wasClean && 1e3 === t.code ? t instanceof Error ? this.onclose(t) : this.onclose() : this.onclose(new Error(`WebSocket closed with status code: ${t.code} (${t.reason || "no reason given"}).`)))
            }
            Wt(t) {
        ...
        class J {
            ...
            async start(t) {
                if (t = t || W.Binary, w.isIn(t, W, "transferFormat"), this.u.log(e.Debug, `Starting connection with transfer format '${W[t]}'.`), "Disconnected" !== this.q) return Promise.reject(new Error("Cannot start an HttpConnection that is not in the 'Disconnected' state."));
            ...
            async F(t) {
                ...
                try {
                    if (this.Pt.skipNegotiation) {
                        if (this.Pt.transport !== M.WebSockets) throw new Error("Negotiation can only be skipped when using the WebSocket transport directly.");
                        this.transport = this.Gt(M.WebSockets), await this.Kt(s, t)
                    } else {
                        let e = null,
                            n = 0;
                        do {
                    ...
                    return this.u.log(e.Error, "Failed to start the connection: " + t), this.q = "Disconnected", this.transport = void 0, this.Ot(), Promise.reject(t)
                }
            }
            async Qt(t) {
                const s = {};
                ...
                for (const n of h) {
                    ...
                    if (h instanceof Error) o.push(`${n.transport} failed:`), o.push(h);
                        ...
                        try {
                            ...
                            if (this.u.log(e.Error, `Failed to start the transport '${n.transport}': ${t}`), a = void 0, o.push(new c(`${n.transport} failed: ${t}`, M[n.transport])), "Connecting" !== this.q) {
            ...
            se(t, s, n) {
                ...
                if (! function (t, e) {
                    return !t || 0 != (e & t)
                }(s, i)) return this.u.log(e.Debug, `Skipping transport '${M[i]}' because it was disabled by the client.`), new h(`'${M[i]}' is disabled by the client.`, i);
                if (!(t.transferFormats.map((t => W[t])).indexOf(n) >= 0)) return this.u.log(e.Debug, `Skipping transport '${M[i]}' because it does not support the requested transfer format '${W[n]}'.`), new Error(`'${M[i]}' does not support ${W[n]}.`);
                if (i === M.WebSockets && !this.Pt.WebSocket || i === M.ServerSentEvents && !this.Pt.EventSource) return this.u.log(e.Debug, `Skipping transport '${M[i]}' because it is not supported in your environment.'`), new o(`'${M[i]}' is not supported in your environment.`, i);
                this.u.log(e.Debug, `Selecting transport '${M[i]}'.`);
                try {
                    return this.Gt(i)
                } catch (t) {
                    return t
            ...
            Vt(t) {
                if (this.u.log(e.Debug, `HttpConnection.stopConnection(${t}) called while in state ${this.q}.`), this.transport = void 0, t = this.zt || t, this.zt = void 0, "Disconnected" !== this.q) {
                    ...
                    if ("Disconnecting" === this.q && this.Ot(), t ? this.u.log(e.Error, `Connection disconnected with error '${t}'.`) : this.u.log(e.Information, "Connection disconnected."), this.Jt && (this.Jt.stop().catch((t => {
        ...
        class Q {
            ...
            withUrl(t, e) {
                return w.isRequired(t, "url"), w.isNotEmpty(t, "url"), this.url = t, this.httpConnectionOptions = "object" == typeof e ? {
